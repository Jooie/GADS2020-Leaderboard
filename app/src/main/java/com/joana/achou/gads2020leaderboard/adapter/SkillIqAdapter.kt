...
class SkillIqAdapter(val context: Context): RecyclerView.Adapter<SkillIqAdapter.ViewHolder>() {

    var list = mutableListOf<SkillIqModel>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.extras.text = "${list[position].score} skill IQ score, ${list[position].country}"


    }


    fun loadList(list: List<SkillIqModel>) {
